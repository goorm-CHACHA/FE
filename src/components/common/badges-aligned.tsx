...
const BadgesAligned = ({items, title, vertical , className, noneChip }: BadgesAlignedProps) => {

  
  return ( 
    <div className={`gap-3 flex flex-col bg-[#333333] py-0.5 rounded-xl mt-2 ${className}`}>
