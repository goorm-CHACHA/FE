...
const StatusForGroup = ({ variants, className }: StatusForGroupProps) => {
  return (
    ...
    <div
      className={`inline-flex relative rounded-2xl bg-gray-900 items-center justify-start py-2 px-4 box-border gap-2 text-left text-xs text-white font-body5-normal-b-12 mt-2 ${className}`}
    >
      <div className={`w-2 h-2 rounded-full ${circleColorMapping[variants]}`} />
