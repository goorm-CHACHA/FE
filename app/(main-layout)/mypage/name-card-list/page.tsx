...
const Page = () => {
  ...
  return (
    <div className="flex flex-col m-auto items-center justify-center w-full md:max-w-md px-6 py-4">
      <div>
      ...
      <div className="flex flex-col items-center w-full">
        <div
          className="p-1 w-full text-center
           md:max-w-md m-auto text-white bg-[#222222] rounded-xl cursor-pointer"
