...
const Page = () => {
  ...
  return (
   <div> 
    ...
    <div className="flex justify-center items-center m-8 p-1 min-w-[250px] max-w-[400px] bg-white text-gray-700 cursor-pointer" onClick={downloadHandler}>이미지 다운로드</div>
    <BottomNavigation/>
  </div>
  )
}
